...
public class RCC_CustomizerExample : RCC_Singleton<RCC_CustomizerExample> {
    ...
    public void SetDriveTrainModeByDropdown(Dropdown dropdown) {
        ...
        switch (dropdown.value) {
            ...
            case 0:
                RCC_Customization.SetDrivetrainMode(RCC_SceneManager.Instance.activePlayerVehicle, RCC_CarControllerV4.WheelType.FWD);
                break;

            case 1:
                RCC_Customization.SetDrivetrainMode(RCC_SceneManager.Instance.activePlayerVehicle, RCC_CarControllerV4.WheelType.RWD);
                break;

            case 2:
                RCC_Customization.SetDrivetrainMode(RCC_SceneManager.Instance.activePlayerVehicle, RCC_CarControllerV4.WheelType.AWD);
                break;
