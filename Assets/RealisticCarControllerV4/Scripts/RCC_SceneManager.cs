...
public class RCC_SceneManager : RCC_Singleton<RCC_SceneManager> {
    ...
    /// </summary>
    public RccPoliceCamera activePlayerCamera;
    public RCC_Camera aactivePlayerCamera;
    /// <summary>
    ...
    private void Awake() {
        ...
        RccPoliceCamera.OnBCGCameraSpawned += RCC_Camera_OnBCGCameraSpawned;
    ...
    private void RCC_Camera_OnBCGCameraSpawned(GameObject BCGCamera) {
        ...
        if (BCGCamera.GetComponent<RCC_Camera>())
            activePlayerCamera = BCGCamera.GetComponent<RccPoliceCamera>();
