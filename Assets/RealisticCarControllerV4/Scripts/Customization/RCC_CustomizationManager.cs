...
public class RCC_CustomizationManager : RCC_Singleton<RCC_CustomizationManager>
{
    ...
    public RCC_SceneManager RCC_SceneManager { get; private set; }

    // REMOVED the constructor that was causing the issue

    protected override void Awake()
    {
        // Call the base class Awake for proper singleton initialization
        base.Awake();
    ...
    private void Start()
    {
        // This is still good to have as a fallback
        if (RCCSceneManager.activePlayerVehicle)
            vehicle = RCCSceneManager.activePlayerVehicle.Customizer;
    }
