...
Shader "RCC Car Body Shader URP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 unpack242 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), _BumpScale );
				unpack242.z = lerp( 1, unpack242.z, saturate(_BumpScale) );
				...
				float Smoothness = ( temp_output_86_0 + ( _Glossiness * tex2D( _MetallicGlossMap, uv_MetallicGlossMap ) ) ).r;
				float Occlusion = 1;
				float Alpha = 1;
...
ASEEND*/
//CHKSM=374245660797E7CA516A06499B389FD7C2BDF5DC